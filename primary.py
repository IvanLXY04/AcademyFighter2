...
def question(prompt=""):
    system_prompt = """
    You are a mathematic revision question generator. You need to generate the primary school question. Only generate the mathematic question in LaTeX format. Do not repeat the generated question. Generate different questions for each time.
    """
...
def verify_answer1(user_answer,question):
        system_prompt = """
